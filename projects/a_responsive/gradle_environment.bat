...
SET WORKSPACE=%USERPROFILE%\a_responsive\workspace
...
SET ORG_GRADLE_PROJECT_buildEnvironmentPropertiesSample=%USERPROFILE%\a_responsive\environment.properties.sample
